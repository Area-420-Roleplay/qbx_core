return {
    ...
    loadingModelsTimeout = 50000, -- Waiting time for ox_lib to load the models before throws an error, for low specs pc

    pauseMapText = 'Area 420 2.0', -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
